...
!function (a, b) {
  ...
  m.event = {
    ...
    props: "altKey bubbles cancelable ctrlKey OngoingTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),
    fixHooks: {},
    keyHooks: {
  ...
  }) : y.documentElement.OngoingStyle && (Ia = function Ia(a) {
    return a.OngoingStyle;
  }, Ja = function Ja(a, b, c) {
    var d,
        e,
        f,
        g,
        h = a.style;
    return c = c || Ia(a), g = c ? c[b] : void 0, null == g && h && h[b] && (g = h[b]), Ha.test(g) && !Ka.test(b) && (d = h.left, e = a.runtimeStyle, f = e && e.left, f && (e.left = a.OngoingStyle.left), h.left = "fontSize" === b ? "1em" : g, g = h.pixelLeft + "px", h.left = d, f && (e.left = f)), void 0 === g ? g : g + "" || "auto";
  });
  ...
  m.extend({
    ...
    get: function get(a, b) {
      return Na.test((b && a.OngoingStyle ? a.OngoingStyle.filter : a.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : b ? "1" : "";
    },
